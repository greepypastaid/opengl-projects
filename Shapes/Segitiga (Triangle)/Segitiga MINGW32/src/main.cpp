...
int main() {
    ...
    // Buat Jendela Sir ukurannya 800 x 600!
    GLFWwindow* window = glfwCreateWindow(800, 600, "Bikin Segitiga", NULL, NULL);
    if (window == NULL) {
    ...
    float vertices[] = {
        -0.5f, -0.5f, 0.0f,  // Titik kiri bawah
         0.5f, -0.5f, 0.0f,  // Titik kanan bawah
         0.0f,  0.5f, 0.0f   // Titik atas
    };
