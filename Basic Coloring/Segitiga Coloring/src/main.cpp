...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "Bikin Segitiga Gradasi AW AW AW UU AA", NULL, NULL);
    if (window == NULL) {
    ...
    float vertices[] = {
        // posisi            // warna
        -0.5f, -0.5f, 0.0f,   0.1f, 0.4f, 0.8f,
         0.5f, -0.5f, 0.0f,   0.5f, 0.9f, 0.4f,
         0.0f,  0.5f, 0.0f,   0.5f, 0.3f, 0.9f
    };
