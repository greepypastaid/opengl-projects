...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 800, "LOGO HP MODERN", NULL, NULL);
    if (window == NULL) {
    ...
    float vertices[] = {
        // H Kiri
        // Posisi           // Warna
        0.1,  0.8, 0.0f,    1.0f, 1.0f, 1.0f, // 0: Atas kanan
        -0.5, -0.4, 0.0f,   1.0f, 1.0f, 1.0f, // 1: Bawah kanan
        -0.7, -0.4, 0.0f,  1.0f, 1.0f, 1.0f, // 2: Bawah kiri
        -0.1,  0.8, 0.0f,   1.0f, 1.0f, 1.0f, // 3: Atas kiri
        
        // H Kanan
        // Posisi           // Warna
        0.1,  0.2, 0.0f,    1.0f, 1.0f, 1.0f, // 4: Atas kanan
        -0.2, -0.4, 0.0f,   1.0f, 1.0f, 1.0f, // 5: Bawah kanan
        -0.4, -0.4, 0.0f,   1.0f, 1.0f, 1.0f, // 6: Bawah kiri
        -0.1,  0.2, 0.0f,   1.0f, 1.0f, 1.0f, // 7: Atas kiri

        // P Kiri
        // Posisi          // Warna
        0.4,  0.2, 0.0f,   1.0f, 1.0f, 1.0f, // 8: Atas kanan
        -0.1, -0.8, 0.0f,  1.0f, 1.0f, 1.0f, // 9: Bawah kanan
        -0.3, -0.8, 0.0f,  1.0f, 1.0f, 1.0f, // 10: Bawah kiri
        0.2,  0.2, 0.0f,   1.0f, 1.0f, 1.0f, //  11: Atas kiri

        // P Kiri
        // Posisi          // Warna
        0.7,  0.2, 0.0f,   1.0f, 1.0f, 1.0f, // 12: Atas kanan
        0.4, -0.4, 0.0f,   1.0f, 1.0f, 1.0f, // 13: Bawah kanan
        0.2, -0.4, 0.0f,   1.0f, 1.0f, 1.0f, // 14: Bawah kiri
        0.5,  0.2, 0.0f,   1.0f, 1.0f, 1.0f, // 15: Atas kiri
    };
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glClearColor(0.0f, 0.3f, 0.9f, 1.0f); // Setting warna sir jadi warna biru
        ...
        glDrawElements(GL_TRIANGLES, 24, GL_UNSIGNED_INT, 0); // Pastikan ini diganti wak buat nyetting seberapa banyak segitiganya! 
