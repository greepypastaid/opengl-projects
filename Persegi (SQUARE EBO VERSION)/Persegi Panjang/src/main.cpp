...
int main() {
    ...
    float vertices[] = {
        0.6f,  0.4f, 0.0f,   // 0: Atas kanan
        0.6f, -0.4f, 0.0f,   // 1: Bawah kanan
        -0.6f, -0.4f, 0.0f,   // 2: Bawah kiri
        -0.6f,  0.4f, 0.0f    // 3: Atas kiri
    };
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0); // Menggambar 6 indeks
